...
int		map_width(char **map_brut, int start);
int		map_length(char **map_brut, int start);
...
void	go_up(t_game *game, t_data *img_map);
void	go_left(t_game *game, t_data *img_map);
void	go_down(t_game *game, t_data *img_map);
void	go_right(t_game *game, t_data *img_map);
...
void	orientation(t_game *game, t_data *img_map);
...
void	print_floor(t_game *game, int pixel_count, int gray);
void	print_texture_east(t_game *game, int pixel_count, int z);
void	print_texture_west(t_game *game, int pixel_count, int z);
void	print_texture_north(t_game *game, int pixel_count, int z);
void	print_texture_south(t_game *game, int pixel_count, int z);
int		print_line(t_game *game, int pixel_count);
int		print_sky(t_game *game, int pixel_count, int gray);
